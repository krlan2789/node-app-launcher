...
export default async function createTurborepoGinNuxtFromGithub(projectName, targetDir) {
    try {
        console.log(cyan(`\n🚀 Fetching TGN Project Template from GitHub...\n`));

        // 1. Download the template
        const spinner = ora(yellow('1. Downloading template...')).start();
        await downloadTemplate('github:krlan2789/lan-turbo-gin-nuxt-template', {
            dir: targetDir,
            force: true,
        });
